...
word_list= ['MUMBAI','DELHI','BANGLORE','HYDERBAD','AHMEDABAD','CHENNAI','KOLKATA','SURAT','PUNE','JAIPUR','AMRITSAR','ALLAHABAD','RANCHI',
...
def newGame():
    ...
    the_word=random.choice(word_list) #selects word randomly
    the_word_withSpaces = " ".join(the_word)  #inserts spaces in between each letter
    lblWord.set(' '.join("_"*len(the_word))) #creates underscored with spaces
